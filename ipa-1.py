...
# In[1]:'''Individual Programming Assignment 1
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    var1 = num_jobs * job_consumption
    var2 = total_material - var1
    return str(var2) + material_units
